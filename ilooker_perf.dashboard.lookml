- dashboard: i_looker_performance_dashboard
  ...
  - title: query per source -daily last 7days
    ...
    conditional_formatting: [{type: high to low, value: !!null '', background_color: !!null '',
        font_color: !!null '', palette: {name: Red to Yellow to Green, colors: ["#F36254",
            "#FCF758", "#4FBC89"], __FILE: sandbox/i_looker_performance_dashboard.dashboard.lookml,
          __LINE_NUM: 36}, bold: false, italic: false, strikethrough: false, fields: !!null '',
        __FILE: sandbox/i_looker_performance_dashboard.dashboard.lookml, __LINE_NUM: 31}]
  ...
  - title: query per source -hourly today
    ...
    conditional_formatting: [{type: high to low, value: !!null '', background_color: !!null '',
        font_color: !!null '', palette: {name: Red to Yellow to Green, colors: ["#F36254",
          ...
          history.query_run_count], __FILE: sandbox/i_looker_performance_dashboard.dashboard.lookml,
        __LINE_NUM: 78}]
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    listen: {}
  ...
  - title: query per user -daily last 7days
    ...
    conditional_formatting: [{type: high to low, value: !!null '', background_color: !!null '',
        ...
        __FILE: sandbox/i_looker_performance_dashboard.dashboard.lookml, __LINE_NUM: 128}]
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    listen: {}
    row: 6
  ...
  - title: dashboard with refresh interval
    ...
    conditional_formatting: [{type: low to high, value: !!null '', background_color: !!null '',
        ...
        __FILE: sandbox/i_looker_performance_dashboard.dashboard.lookml, __LINE_NUM: 220}]
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    series_types: {}
    listen: {}
